...
bool Password::triple(){
	return (
			(first==second && second!=third)||
			(second==third && (third!=fourth && second != first))||
			(third==fourth && (fourth!=fifth && third != second))||
			(fourth==fifth && (fifth!=sixth && fourth != third))||
			(fifth==sixth && fifth != fourth)
		   );
};

bool Password::validate(){
	return increasing() && adjacent() && triple();
}
